...
void generate(PVector position_)
{
  ...
  particle.myColor= lerpColor(color(int(random(0,191)),int(random(0,191)),int(random(0,191))), color(int(random(0,255)),int(random(0,255)),int(random(0,255))), random(0,1));
  particle.size = int(random(5,67));
